							...
							<div class="row g-2">
								<div class="col-md" >
							        ...
							        <div class="" >
						             ...
						             <textarea class="form-control" name="sobreA" id="exampleFormControlTextarea1" rows="18"></textarea>
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="">
                                        ...
                                        <textarea class="form-control" name="sobreB" id="exampleFormControlTextarea1" rows="18"></textarea>
                                    </div> 
                                </div>
                            </div>
				        </div>
