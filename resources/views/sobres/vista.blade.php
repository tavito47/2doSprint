...
<div class="container">
        <div class= "row">
				<div class="col-md" >
					...
					<div class="" > 
					<textarea readonly class="form-control texbordenone" id="exampleFormControlTextarea1" rows="18">{{$ultimoSobre->sobreA}}</textarea>
				...
				<div class="col-md">
					...
					<div class="">
					<textarea readonly class="form-control texbordenone tex-light" id="exampleFormControlTextarea1" rows="18">{{$ultimoSobre->sobreB}}</textarea>
