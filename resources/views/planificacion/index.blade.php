            ...
            @foreach ($planificaciones as $item)
              <tr>
                  ...
                  <td>
                      ...
                      <form action="{{ route('planificacion.destroy',$item->id) }}" method="POST">
                        <a href="{{ route('planificacion.edit',$item->id)}}" title="Editar" class="btn btn-white btn-sm" ><i class="fas fa-edit"></i> </a>

                                @csrf
                                @method('DELETE')
                                <button type="submit" title="Eliminar" class="btn btn-white btn-sm"><i class="fas fa-trash-alt"></i></button>
                       </form>
